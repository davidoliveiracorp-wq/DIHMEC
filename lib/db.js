...
export const DEFAULT_SUPER_ADMIN_PASSWORD = 'Dihmec@2026';
...
// Cria os super admins padrao se nao existirem; promove a superadmin caso
// ja existam como usuario comum. Roda em toda inicializacao do schema.
export async function ensureSuperAdmins() {
  ...
  users.forEach((u) => {
    ...
    if (isSuperAdminEmail(email) && u.role !== 'superadmin') {
      u.role = 'superadmin';
      changed = true;
    }
  });
